...
public class HintCodeForm : Form
{
    ...
    private readonly HintSnippetStore _store = HintSnippetStore.Load();
    ...
    public HintCodeForm(Action<string> insertCode)
    {
    ...
    private Control BuildRightPanel()
    {
        ...
        buttonRow.Controls.AddRange(new Control[] { _newBtn, _saveBtn, _deleteBtn, _insertBtn });
        ...
        form.Controls.Add(new Label { Text = "Type", Dock = DockStyle.Fill, TextAlign = ContentAlignment.MiddleLeft }, 0, 1);
        form.Controls.Add(_typeCombo, 1, 1);
        form.Controls.Add(new Label { Text = "Tag, Keywords", Dock = DockStyle.Fill, TextAlign = ContentAlignment.MiddleLeft }, 0, 2);
        form.Controls.Add(_tagsBox, 1, 2);
        form.Controls.Add(new Label { Text = "Description", Dock = DockStyle.Fill, TextAlign = ContentAlignment.MiddleLeft }, 0, 3);
        form.Controls.Add(_descriptionBox, 1, 3);
        form.Controls.Add(_codeBox, 0, 4);
    ...
    private void List_DrawItem(object? sender, DrawItemEventArgs e)
    {
        ...
        e.Graphics.DrawString(s.ModifiedDate.ToString("dd/MM/yyyy"), font, mutedBrush, e.Bounds.Left + 54, e.Bounds.Top + 3);
    ...
    private void ShowDetail(HintSnippet? snippet)
    {
        ...
        RunHighlight();
        _createdLabel.Text = snippet is null ? "" : $"Created: {snippet.CreatedDate:dd/MM/yyyy HH:mm} by {snippet.CreatedBy}";
        _modifiedLabel.Text = snippet is null ? "" : $"Modified: {snippet.ModifiedDate:dd/MM/yyyy HH:mm} by {snippet.ModifiedBy}";
        _deleteBtn.Enabled = snippet != null;
    ...
    private void SaveCurrent()
    {
        ...
        if (_editing is null)
        {
            ...
            {
                Category = (string)(_categoryCombo.SelectedItem ?? "JS"),
                Type = _typeCombo.Text,
                Tags = _tagsBox.Text,
